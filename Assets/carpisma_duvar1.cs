...
public class carpisma_duvar1 : MonoBehaviour
...

{
    ...
    void OnTriggerEnter(Collider nesne)
    {
        if (nesne.gameObject.name == "karakter")
        {
            ...
            vagon_2.position = new Vector3(row_orta.position.x, vagon_2.position.y, vagon_2.position.z + Randomsayi);
            vagon_3.position = new Vector3(row_orta.position.x, vagon_3.position.y, vagon_3.position.z + Randomsayi);
            vagon_4.position = new Vector3(row_orta.position.x, vagon_4.position.y, vagon_4.position.z + Randomsayi);
            vagon_5.position = new Vector3(row_sol.position.x, vagon_5.position.y, vagon_5.position.z + Randomsayi);
            vagon_6.position = new Vector3(row_sol.position.x, vagon_6.position.y, vagon_6.position.z + Randomsayi);
        }
